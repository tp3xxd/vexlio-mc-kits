...
public class KitbattleAPI {
   public static HashMap<String, String> getAllPlayersData() {
      Kitbattle var0 = Kitbattle.getInstance();
   ...
   public static List<File> getPlayersFiles() {
      ...
      File var1 = new File(Kitbattle.getInstance().getDataFolder(), "players");
   ...
   public static List<java.util.Map.Entry<String, Integer>> getTopPlayers(HashMap<String, String> var0, Stat var1, int var2) {
      if (var2 < 1) {
         ...
         for(String var5 : var0.keySet()) {
            ...
            if (var1.equals(KitbattleAPI.Stat.ELO) && var6.length < 13) {
               var3.put(var5, Kitbattle.getInstance().config.StartingELO);
            } else {
