...
public class KitCommand extends SubCommand {
   public KitCommand() {
      super("kitbattle.kit", true, "Give/Create/Delete/Rename/Enable/Disable");
   }

   public boolean execute(Kitbattle var1, final Messages var2, final CommandSender var3, final String[] var4) {
      if (var4.length != 1 && (var4[1].equalsIgnoreCase("Give") || var4[1].equalsIgnoreCase("Create") || var4[1].equalsIgnoreCase("Delete") || var4[1].equalsIgnoreCase("Rename") || var4[1].equalsIgnoreCase("Enable") || var4[1].equalsIgnoreCase("Disable"))) {
         ...
         if (var5.equals("give")) {
            if (var4.length < 4) {
               var3.sendMessage(var2.prefix + "Usage: /kb " + ChatColor.GREEN + "Kit " + ChatColor.GRAY + "Give <Player> <Kit>");
               return true;
            }
            ...
            if (var3 instanceof Player) {
               ...
               if (var4.length < 6 || !var1.isMaterial(var4[3].split(":")[0].toUpperCase()) || !Utils.checkNumbers(var4[4], var4[5])) {
                  var33.sendMessage(var2.prefix + "Usage: /kb " + ChatColor.GREEN + "Kit " + ChatColor.GRAY + "Create <Name> <Logo " + ChatColor.LIGHT_PURPLE + ChatColor.UNDERLINE + "(MATERIAL ENUM) " + ChatColor.GRAY + "> <Price> <Selection Cooldown>");
                  return true;
               }
               ...
               Collection var13 = var33.getActivePotionEffects();
            ...
            if (var4.length == 2) {
               var3.sendMessage(var2.prefix + "Usage: /kb " + ChatColor.GREEN + "Delete" + ChatColor.GRAY + " <Kit>");
               return true;
            }
            ...
            if (var4.length < 4) {
               var3.sendMessage(var2.prefix + "Usage: /kb " + ChatColor.GREEN + "Kit" + ChatColor.GRAY + " rename <Kit> <New Name>");
               return true;
            }
            ...
            (new BukkitRunnable() {
               final List<File> files = KitbattleAPI.getPlayersFiles();
            ...
            if (var4.length < 3) {
               var3.sendMessage(var2.prefix + "Usage: /kb " + ChatColor.GREEN + "Kit" + ChatColor.GRAY + " enable <Kit>");
               return true;
            }
            ...
            if (var4.length < 3) {
               var3.sendMessage(var2.prefix + "Usage: /kb " + ChatColor.GREEN + "Kit" + ChatColor.GRAY + " disable <Kit>");
               return true;
            }
