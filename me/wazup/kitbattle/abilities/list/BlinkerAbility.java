...
public class BlinkerAbility extends Ability {
   ...
   public boolean execute(Player var1, PlayerData var2, Event var3) {
      ...
      if (var2.hasCooldown(var1, "Blinker")) {
         ...
         var6.setMetadata("tnts", new FixedMetadataValue(Kitbattle.getInstance(), true));
         ...
         var5.sendMessage(((String)Kitbattle.getInstance().msgs.messages.get("Player-Blink")).replace("%player%", var1.getName()));
         return false;
      }
   }
}
