...
public class FileManager {
      ...
      if (var1.getConfigurationSection("Kits") != null) {
         ...
         for(String var5 : var1.getConfigurationSection("Kits").getKeys(false)) {
            ...
            try {
               ...
               Bukkit.getConsoleSender().sendMessage("[KitBattle] Failed to create the logo for the kit: " + var5 + ", due to that, the whole kit wont load!, make sure you have the correct format!");
            ...
            for(String var27 : this.armorParts) {
               try {
                  ...
                  Bukkit.getConsoleSender().sendMessage("[KitBattle] Failed to create a " + var27 + " for the kit: " + var5 + ", due to that, the whole kit wont load!, make sure you have the correct format!");
            ...
            for(String var30 : var1.getStringList("Kits." + var5 + ".Items")) {
               try {
                  ...
                  Bukkit.getConsoleSender().sendMessage("[KitBattle] Failed to create this item: " + var30 + " for the kit: " + var5 + ", due to that, the whole kit wont load!, make sure you have the correct format!");
   ...
   public void executeDatabaseUpdate(final CommandSender var1, final String var2, final BukkitRunnable var3, final String[] var4) {
      ...
      if (this.plugin.config.useMySQL) {
         ...
         List var5 = KitbattleAPI.getPlayersFiles();
