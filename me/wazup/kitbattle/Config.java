...
public class Config {
   ...
   public void loadConfig() {
      FileConfiguration var1 = Kitbattle.getInstance().getConfig();
      ...
      if (this.scoreboardTitleAnimationFrames.size() < 2) {
         ...
         Bukkit.getConsoleSender().sendMessage(Kitbattle.getInstance().msgs.prefix + "Scoreboard animation was disabled because there are not enough amount of frames!");
      } else if (this.scoreboardTitleAnimationEnabled) {
         Bukkit.getConsoleSender().sendMessage(Kitbattle.getInstance().msgs.prefix + "Scoreboard title animation has been enabled and it contains " + ChatColor.AQUA + this.scoreboardTitleAnimationFrames.size() + ChatColor.GRAY + " frame(s)!");
      }
      ...
      if (var1.getConfigurationSection("Killstreaks") == null) {
         ...
         Kitbattle.getInstance().saveConfig();
      }
      ...
      FileConfiguration var22 = Kitbattle.getInstance().fileManager.getConfig("achievements.yml");
      ...
      FileConfiguration var36 = Kitbattle.getInstance().fileManager.getConfig("signs.yml");
