...
public class AchievementsManager {
   ...
   public AchievementsManager(VexlioKits var1) {
      this.plugin = var1;
   ...
   public SmartInventory getAchievements(PlayerData var1) {
      ...
      if (var12.length != AchievementsManager.AchievementType.values().length) {
         ...
         for(AchievementType var7 : AchievementsManager.AchievementType.values()) {
            ...
            for(Achievement var10 : (ArrayList<Achievement>)this.achievements.get(var7)) {
   ...
   public void checkPlayer(Player var1, AchievementType var2, int var3) {
      if (this.enabled) {
         for(Achievement var5 : (ArrayList<Achievement>)this.achievements.get(var2)) {
            if (var3 == var5.score) {
               var5.send(var1);
               break;
            }
   ...
   public class Achievement {
      ...
      public void send(Player var1) {
         ...
         for(String var4 : VexlioKits.getInstance().msgs.achievementMessages) {
