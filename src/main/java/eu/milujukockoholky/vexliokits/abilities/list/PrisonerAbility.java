   ...
   public boolean execute(Player var1, PlayerData var2, Event var3) {
      if (var3.getEventName().equals("PlayerInteractEvent")) {
         if (var2.hasCooldown(var1, "Prisoner")) {
            ...
            ((Snowball)var1.launchProjectile(Snowball.class)).setMetadata("prison", new FixedMetadataValue(VexlioKits.getInstance(), true));
            return true;
         }
      } else {
         ...
         if (!var4.getDamager().hasMetadata("prison")) {
            ...
            ArrayList<Block> var7 = Utils.getCageBlocks(var6.getLocation().add((double)0.0F, (double)9.0F, (double)0.0F));
            boolean var8 = true;
            ...
            if (!var8) {
               ...
               final ArrayList<BlockState> var12 = new ArrayList<>();
