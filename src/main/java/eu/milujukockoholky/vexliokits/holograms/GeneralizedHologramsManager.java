package eu.milujukockoholky.vexliokits.holograms;
...
public class GeneralizedHologramsManager {
   ...
   public void setLeaderboardLocation(Location var1, boolean var2) {
      ...
      if (var1 == null) {
         ...
         if (var2) {
            VexlioKits.getInstance().startLeaderboardUpdater();
         }
   ...
   public void updateLeaderboards(HashMap<VexlioKitsAPI.Stat, Map.Entry<String, Integer>> var1) {
      ...
      for(VexlioKitsAPI.Stat var4 : var1.keySet()) {
